...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "ezzatisawesome.blog.blog.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "ezzatisawesome.blog.blog.MsgCreatePostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	0xd7, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x92, 0x48, 0xad, 0xaa, 0x4a, 0x2c,
	0xc9, 0x2c, 0x4e, 0x2c, 0x4f, 0x2d, 0xce, 0xcf, 0x4d, 0xd5, 0x03, 0xc9, 0x82, 0x09, 0xa5, 0x60,
	...
	0x42, 0x5c, 0x2c, 0x49, 0xf9, 0x29, 0x95, 0x12, 0xcc, 0x60, 0x41, 0x30, 0x5b, 0x49, 0x9c, 0x4b,
	0x14, 0xc5, 0xd0, 0xa0, 0xd4, 0xe2, 0x82, 0xfc, 0xbc, 0xe2, 0x54, 0xa3, 0x5c, 0x2e, 0x66, 0xdf,
	0xe2, 0x74, 0xa1, 0x34, 0x2e, 0x2e, 0x24, 0x1b, 0xd5, 0xf5, 0x70, 0xb9, 0x4e, 0x0f, 0xc5, 0x14,
	0x29, 0x7d, 0x22, 0x15, 0xc2, 0xac, 0x73, 0x72, 0x3d, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39,
	0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63,
	0x39, 0x86, 0x28, 0xed, 0xf4, 0xcc, 0x92, 0x8c, 0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x54,
	0x43, 0xf5, 0xc1, 0x21, 0x57, 0x01, 0xa1, 0x4a, 0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0x81,
	0x68, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x8d, 0xb7, 0x3f, 0x4f, 0x55, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ezzatisawesome.blog.blog.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ezzatisawesome.blog.blog.Msg/CreatePost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ezzatisawesome.blog.blog.Msg",
